...
namespace Energistics.DataAccess.COMPLETION100
{
    ...
    public class MudSubClass : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private readonly static MudSubClass nonaqueousInvertEmulsionFluids;
        /// <summary>
        /// An invert-emulsion mud or an emulsion with an Diesel, Mineral oil or a Synthetic base fluid as the continuous phase
        /// </summary>
        [EnumValueNameAttribute("non-aqueous (invert emulsion) fluids")]
        public static MudSubClass NonaqueousInvertEmulsionFluids
        {
            get 
            {
                return nonaqueousInvertEmulsionFluids;
            }
        }
        ...
        static MudSubClass()
        {
            ...
            nonaqueousInvertEmulsionFluids = 
                new MudSubClass("non-aqueous (invert emulsion) fluids")
                {
