...
namespace Energistics.DataAccess.PRODML121
{
    ...
    public class FacilityParameter : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static FacilityParameter openingSize;
        /// <summary>
        /// The size of an opening. For example, a valve diameter. This should be implemented as an lengthMeasure. A value of zero indicates that it is closed.
        /// </summary>
        ...
        public static FacilityParameter OpeningSize
        {
            get 
            {
                if (openingSize == null)
                {
                    openingSize = new FacilityParameter("opening size");
                    openingSize.Description = "The size of an opening. For example, a valve diameter. This should be implemented as an lengthMeasure. A value of zero indicates that it is closed.";
                }
                return openingSize;
            }
        }

        private static FacilityParameter relativeOpeningSize;
        /// <summary>
        /// The size of an opening. This should be implemented as an lengthPerLengthMeasure. A value of 100 % indicates that it is open. A value of zero indicates that it is closed.
        /// </summary>
        ...
        public static FacilityParameter RelativeOpeningSize
        {
            get 
            {
                if (relativeOpeningSize == null)
                {
                    relativeOpeningSize = new FacilityParameter("relative opening size");
                    relativeOpeningSize.Description = "The size of an opening. This should be implemented as an lengthPerLengthMeasure. A value of 100 % indicates that it is open. A value of zero indicates that it is closed.";
                }
                return relativeOpeningSize;
            }
        }

        private static FacilityParameter pressure;
        /// <summary>
        /// A pressure value within a flowing system. This should be implemented as an pressureMeasure.
        /// </summary>
        ...
        public static FacilityParameter Pressure
        {
            get 
            {
                if (pressure == null)
                {
                    pressure = new FacilityParameter("pressure");
                    pressure.Description = "A pressure value within a flowing system. This should be implemented as an pressureMeasure.";
                }
                return pressure;
            }
        }

        private static FacilityParameter temperature;
        /// <summary>
        /// A temperature value within a flowing system. This should be implemented as a temperatureMeasure.
        /// </summary>
        ...
        public static FacilityParameter Temperature
        {
            get 
            {
                if (temperature == null)
                {
                    temperature = new FacilityParameter("temperature");
                    temperature.Description = "A temperature value within a flowing system. This should be implemented as a temperatureMeasure.";
                }
                return temperature;
            }
        }

        private static FacilityParameter shutinPressure;
        /// <summary>
        /// A pressure value within a non-flowing system. This should be implemented as an pressureMeasure.
        /// </summary>
        ...
        public static FacilityParameter ShutinPressure
        {
            get 
            {
                if (shutinPressure == null)
                {
                    shutinPressure = new FacilityParameter("shutin pressure");
                    shutinPressure.Description = "A pressure value within a non-flowing system. This should be implemented as an pressureMeasure.";
                }
                return shutinPressure;
            }
        }

        private static FacilityParameter shutinTemperature;
        /// <summary>
        /// A temperature value within a non-flowing system. This should be implemented as a temperatureMeasure.
        /// </summary>
        ...
        public static FacilityParameter ShutinTemperature
        {
            get 
            {
                if (shutinTemperature == null)
                {
                    shutinTemperature = new FacilityParameter("shutin temperature");
                    shutinTemperature.Description = "A temperature value within a non-flowing system. This should be implemented as a temperatureMeasure.";
                }
    ...
    public class ReportingFacility : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static ReportingFacility casing;
        /// <summary>
        ...
        public static ReportingFacility Casing
        {
            get 
            {
                if (casing == null)
                {
                    casing = new ReportingFacility("casing");
                    casing.Description = "A production casing (steel pipe) used to seal and stabilize a wellbore.";
                }
                return casing;
            }
        }
        ...
        public static ReportingFacility Formation
        {
            get 
            {
                if (formation == null)
                {
                    ...
                    formation.Description = "A bed or deposit composed throughout of substantially the same kind of rock.";
                }
                return formation;
            }
        }
        ...
        /// <summary>
        /// A an accessory system of piping to a main piping system that serves to divide a flow into several parts, to combine several flows into one, or to reroute a flow to any one of several possible destinations.
        /// </summary>
        ...
        public static ReportingFacility Manifold
        {
            get 
            {
                if (manifold == null)
                {
                    ...
                    manifold.Description = "A an accessory system of piping to a main piping system that serves to divide a flow into several parts, to combine several flows into one, or to reroute a flow to any one of several possible destinations.";
                }
                return manifold;
            }
        }

        private static ReportingFacility organizationalUnit;
        /// <summary>
        ...
        public static ReportingFacility OrganizationalUnit
        {
            get 
            {
                ...
                {
                    organizationalUnit = new ReportingFacility("organizational unit");
                    organizationalUnit.Description = "A logical unit of organization for production reporting.";
                }
                return organizationalUnit;
            }
        }

        private static ReportingFacility packer;
        /// <summary>
        ...
        public static ReportingFacility Packer
        {
            get 
            {
                if (packer == null)
                {
                    packer = new ReportingFacility("packer");
                    packer.Description = "A device used to make a seal between the outside of the production tubing and the inside of the casing.";
                }
                return packer;
            }
        }

        private static ReportingFacility perforatedInterval;
        /// <summary>
        ...
        public static ReportingFacility PerforatedInterval
        {
            get 
            {
                if (perforatedInterval == null)
                {
                    perforatedInterval = new ReportingFacility("perforated interval");
                    perforatedInterval.Description = "The section of wellbore that has been prepared for production by creating channels between the reservoir formation and the wellbore.";
                }
        ...
        public static ReportingFacility PlantProcessing
        {
            get 
            {
                if (plantProcessing == null)
                {
                    ...
                    plantProcessing.Description = "A facility that processes natural gas to achieve the recovery of natural gas liquids.";
                }
        ...
        private static ReportingFacility productionTubing;
        /// <summary>
        /// A a tube placed in a wellbore through which production fluids travel.
        /// </summary>
        ...
        public static ReportingFacility ProductionTubing
        {
            get 
            {
                if (productionTubing == null)
                {
                    productionTubing = new ReportingFacility("production tubing");
                    productionTubing.Description = "A a tube placed in a wellbore through which production fluids travel.";
                }
        ...
        public static ReportingFacility RegulatingValve
        {
            get 
            {
                if (regulatingValve == null)
                {
                    ...
                    regulatingValve.Description = "A device used to regulate the rate of flow of a fluid.";
                }
    ...
    public class WftFlowingIntervalKind : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftFlowingIntervalKind probe;
        /// <summary>
        ...
        public static WftFlowingIntervalKind Probe
        {
            get 
            {
                if (probe == null)
                {
                    probe = new WftFlowingIntervalKind("probe");
                    probe.Description = "This is used to identify a probe connection between reservoir and WFT tool. ";
                }
                return probe;
            }
        }

        private static WftFlowingIntervalKind packedInterval;
        /// <summary>
        ...
        public static WftFlowingIntervalKind PackedInterval
        {
            get 
            {
                if (packedInterval == null)
                {
                    packedInterval = new WftFlowingIntervalKind("packed interval");
                    packedInterval.Description = "This is to identify a connection between reservoir and WFT tool which is between a pair of packers, ie akin to the flow connection of a traditional drill stem test (DST) though usually on a smaller scale.";
                }
                return packedInterval;
            }
        }

        private static WftFlowingIntervalKind unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftFlowingIntervalKind Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftFlowingIntervalKind("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
    ...
    /// <summary>
    /// This is used to identify events occuring during the operation of a 
    ///		wireline formation tester (WFT) at a given station (ie a temporary fixed position 
    ...
    public class WftEventKind : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftEventKind toolSet;
        /// <summary>
        ...
        public static WftEventKind ToolSet
        {
            get 
            {
                if (toolSet == null)
                {
                    toolSet = new WftEventKind("tool set");
                    toolSet.Description = "This event describes the process of setting the WFT tool prior to tests being made at the station.";
                }
                return toolSet;
            }
        }

        private static WftEventKind toolRetract;
        /// <summary>
        ...
        public static WftEventKind ToolRetract
        {
            get 
            {
                if (toolRetract == null)
                {
                    toolRetract = new WftEventKind("tool retract");
                    toolRetract.Description = "This event describes the process of retracting the WFT tool after tests being made at the station, ready to move to another station or be retrieved from the wellbore.";
                }
                return toolRetract;
            }
        }

        private static WftEventKind unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftEventKind Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftEventKind("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
    ...
    ///		conventional where flow is occuring and being measured, and observation where there is 
    ///		no flow and merely pressure observation of the effect at this station of flow which is 
    ///		occuring at a different station.
    /// </summary>
    public class WftStationKind : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftStationKind conventional;
        /// <summary>
        /// This is used to identify a station where flow is occuring and being measured, such as pressure, temperature and flowrate.
        /// </summary>
        ...
        public static WftStationKind Conventional
        {
            get 
            {
                ...
                {
                    conventional = new WftStationKind("conventional");
                    conventional.Description = "This is used to identify a station where flow is occuring and being measured, such as pressure, temperature and flowrate.";
                }
                return conventional;
            }
        }

        private static WftStationKind observation;
        /// <summary>
        /// This is used to identify a station where there is no flow occuring but the WFT tool is set and making pressure observation of the effect at this station of flow which is occuring at a different station.
        /// </summary>
        ...
        public static WftStationKind Observation
        {
            get 
            {
                if (observation == null)
                {
                    observation = new WftStationKind("observation");
                    observation.Description = "This is used to identify a station where there is no flow occuring but the WFT tool is set and making pressure observation of the effect at this station of flow which is occuring at a different station.";
                }
                return observation;
            }
        }

        private static WftStationKind unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftStationKind Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftStationKind("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
    ...
    /// <summary>
    /// This is used to characterise the kind of Test being carried out at a given time at 
    ...
    public class WftTestKind : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftTestKind drawdown;
        /// <summary>
        ...
        public static WftTestKind Drawdown
        {
            get 
            {
                if (drawdown == null)
                {
                    drawdown = new WftTestKind("drawdown");
                    drawdown.Description = "A drawdown test is where reservoir fluid is flowing into the WFT tool via a connection described by the flowing interval kind element.";
                }
                return drawdown;
            }
        }

        private static WftTestKind buildup;
        /// <summary>
        ...
        public static WftTestKind Buildup
        {
            get 
            {
                if (buildup == null)
                {
                    buildup = new WftTestKind("buildup");
                    buildup.Description = "A build up test is where there is no flow of reservoir fluid into the WFT tool, but because the connection described by the flowing interval kind element remains in place, the WFT tool is measuring the pressure in the reservoir at the sandface (ie the inside face of the wellbore). A buildup must be preceded by one or more drawdowns (during which the sandface pressure will have dropped), and during the buildup the pressure will rise again. Hence the name, buildup.";
                }
                return buildup;
            }
        }

        private static WftTestKind unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftTestKind Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftTestKind("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
    ...
    public class WftTestResultKind : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftTestResultKind buildupResult;
        /// <summary>
        ...
        public static WftTestResultKind BuildupResult
        {
            get 
            {
                if (buildupResult == null)
                {
                    buildupResult = new WftTestResultKind("buildup result");
                    buildupResult.Description = "This refers to the result of analysis of a buildup. More specialist buildup results could be added to the enum list such as buildup horner analysis, etc.";
                }
                return buildupResult;
            }
        }

        private static WftTestResultKind drawdownResult;
        /// <summary>
        ...
        public static WftTestResultKind DrawdownResult
        {
            get 
            {
                ...
                {
                    drawdownResult = new WftTestResultKind("drawdown result");
                    drawdownResult.Description = "This refers to the result of analysis of a drawdown.";
                }
                return drawdownResult;
            }
        }

        private static WftTestResultKind unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftTestResultKind Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftTestResultKind("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
    ...
    /// <summary>
    /// This is used to charaterize the test data being described.  A curve of data
    ...
    ///		Alternatively a single parameter may characterise the test in some manner (by use of the
    ...
    public class WftTestDataRole : Energistics.DataAccess.EnumValue.EnumValue
    {
        ...
        private static WftTestDataRole pressureStream;
        /// <summary>
        ...
        public static WftTestDataRole PressureStream
        {
            get 
            {
                ...
                {
                    pressureStream = new WftTestDataRole("pressure stream");
                    pressureStream.Description = "This would refer to a curveSection element and indicate the curve is a curve (a time series of data points) containing the pressure data.";
                }
                return pressureStream;
            }
        }

        private static WftTestDataRole flowHistory;
        /// <summary>
        ...
        public static WftTestDataRole FlowHistory
        {
            get 
            {
                if (flowHistory == null)
                {
                    flowHistory = new WftTestDataRole("flow history");
                    flowHistory.Description = "This would refer to a curveSection element and indicate the curve is a curve (a time series of data points) containing the flowrate history data (used in pressure transient analysis.";
                }
                return flowHistory;
            }
        }

        private static WftTestDataRole unknown;
        /// <summary>
        /// The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.
        /// </summary>
        [EnumValueNameAttribute("unknown")]
        public static WftTestDataRole Unknown
        {
            get 
            {
                if (unknown == null)
                {
                    unknown = new WftTestDataRole("unknown");
                    unknown.Description = "The value is not known. This value should not be used in normal situations. All reasonable attempts should be made to determine the appropriate value. Use of this value may result in rejection in some situations.";
                }
                return unknown;
            }
