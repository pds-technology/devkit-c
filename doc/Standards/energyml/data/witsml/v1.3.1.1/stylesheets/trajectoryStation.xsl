...
<xsl:template match="/">
	...
	<head>
		<title>
			WITSML Trajectory Station Data Object
		</title>
	</head>
	<body>
	<table  border="2" align="center">
		<tr><th colspan="9" ><font size="+2" color="blue">WITSML</font></th></tr>
		<tr><th colspan="9"><font size="+2" color="blue">Trajectory Station Information</font></th></tr>
		<xsl:for-each select="witsml:trajectoryStations">
			<xsl:for-each select="witsml:trajectoryStation">
				...
				<tr>	<td colspan="3"><font size="-1" color="blue"><b>Wellbore uid: </b></font>  <font size="-1"><xsl:value-of select="@uidWellbore"/></font></td>
					<td colspan="6"><font size="-1" color="blue"><b>uidTraj: </b></font>  <font size="-1"><xsl:value-of select="@uidTrajectory"/></font></td></tr>
				<tr>	<td colspan="3"><font size="-1" color="blue"><b>Wellbore Name: </b></font>  <font size="-1"><xsl:value-of select="witsml:nameWellbore"/></font></td>
					<td colspan="6"><font size="-1" color="blue"><b>Traj. Name: </b></font>  <font size="-1"><xsl:value-of select="witsml:nameTrajectory"/></font></td></tr>
				<tr>	<td colspan="3"><font size="-1"><b>Traj. Station uid: </b></font>  <font size="-1"><xsl:value-of select="@uid"/></font></td></tr>
				<tr>	<td colspan="4"><font size="-1"><b>Target uid: </b></font>  <font size="-1"><xsl:value-of select="witsml:nameTarget/@uidRef"/></font></td>
				 	<td colspan="5"><font size="-1"><b>Target name: </b></font>  <font size="-1"><xsl:value-of select="witsml:nameTarget"/></font></td></tr>
				...
				<tr>	<td colspan="2"><font size="-1"><b>Hole inclination: </b>  <xsl:apply-templates select="witsml:inc" mode="valueWithUomRef"/></font></td>
				...
				<tr><td colspan="1" align="right"><font size="-1"><b>Survey tool: </b></font></td>
					...
					<td colspan="2"><font size="-1"><b>Dip uncert.: </b>  <xsl:apply-templates select="witsml:dipAng" mode="valueWithUomRef"/></font></td>
